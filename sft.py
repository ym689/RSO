...
def train(args, train_dataset, model, tokenizer):
    ...
    # Train!
    logging.info("***** Begin to run training *****")
    ...
    for e in train_iterator:
        ...
        #0708 save all train epoch's result
        output_dir = os.path.join(args.output_dir, f'epoch_{e}')
...
def evaluate(args, model, tokenizer, save_output=False):
    ...
    print(f'evaluate {args.set_name} set')
...
def main():
    ...
    ## Required parameters
    parser.add_argument('--data_name', default='inspired', type=str,
                        help="dataset name")
    parser.add_argument('--set_name', default='valid', type=str,
                        help="dataset split name")
    parser.add_argument('--model_name', default='roberta', type=str,
                        help="model name")
    parser.add_argument("--model_name_or_path", default='/path/to/roberta-large', #roberta-large
                        type=str, help="model name or path")
    parser.add_argument("--output_dir", default='/path/to/sft_dir', type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--data_dir", default='RSO/data/sft_data', type=str,
                        help="The data directory.")
    parser.add_argument("--cache_dir", default='/path/to/cache', type=str,
    ...
    parser.add_argument("--do_lower_case", default=False, action='store_false',
    ...
    args.output_dir = os.path.join(args.output_dir, f"lr_{args.learning_rate}", f"wd_{args.weight_decay}")
